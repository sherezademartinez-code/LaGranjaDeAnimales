 ...
 * - El código debe tener exactamente 5 caracteres que sean dígitos (0-9) 
 ...
 * 
 * Si algún parámetro no cumple estas condiciones, se lanza una excepción 
 * IllegalArgumentException
 *
 * @param codigo el código identificativo del animal, compuesto por 5 
 *               caracteres alfanuméricos en minúscula
 * @param fechaNacimiento la fecha de nacimiento del animal en formato 
 *                        "yyyy-MM-dd"
 ...
 * @throws IllegalArgumentException si el código no cumple el patrón, el 
 *                                  sexo es incorrecto, el peso no es 
 *                                  positivo o la fecha no tiene un 
 *                                  formato válido
 */
